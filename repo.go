...
type Repository struct {
	...
	DependencyScanningBranchName  string `xorm:"VARCHAR(255)"`
	IacMisconfigurationBranchName string `xorm:"VARCHAR(255)"`
	IsDependencyListEnabled       bool   `xorm:"NOT NULL DEFAULT false"`
	SecretDetectionBranchName     string `xorm:"VARCHAR(255)"`
	CodeScanningBranchName        string `xorm:"VARCHAR(255)"`
...
// GetRepositoriesByOrgID return list repository
func GetRepositoriesByOrgID(ctx context.Context, orgID int64) ([]*Repository, error) {
